...
-(void)SendDict:(NSDictionary *)dict {
    ...
    RTCDataBuffer * buffer4 = [[RTCDataBuffer alloc] initWithData:dictData2 isBinary:YES];
    [self.dataChannel_ sendData:buffer4];
    ...
    RTCDataBuffer * buffer2 = [[RTCDataBuffer alloc] initWithData:dictData isBinary:YES];
    [self.dataChannel_ sendData:buffer2];
    
    RTCDataBuffer * buffer1 = [[RTCDataBuffer alloc] initWithData:dictData isBinary:NO];
    [self.dataChannel_ sendData:buffer1];
}
...
//    [self.dataChannel_ sendData:buffer];
    ...
    RTCDataBuffer * buffer2 = [[RTCDataBuffer alloc] initWithData:data isBinary:NO];
    [self.dataChannel_ sendData:buffer2];
}
